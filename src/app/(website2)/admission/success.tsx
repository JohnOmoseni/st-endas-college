        ...
        <div className="flex-column !items-center gap-6">
          ...
          <div className="flex-column mb-4 max-w-xl">
            <p className="px-1 text-center text-bg leading-5">
              <span className="font-medium text-lg block">Your application has been received.</span>
              <span className="mb-2 inline-block">
                You are required to come for an entrance examination at the school premises on
                either of the following dates:
              </span>
              <span className="block font-semibold">Saturday 19th August 2023 </span>
              <span className="block font-semibold">Saturday 2nd August 2023</span>
            </p>
          </div>
