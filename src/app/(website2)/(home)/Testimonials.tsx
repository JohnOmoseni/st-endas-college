            ...
            return (
              ...
              >
                <div className="w-full grid grid-cols-[max-content_1fr] gap-3  sm:min-h-[70px] sm:max-h-[80px]">
                  ...
                  <div>
                    <h3 title={name} className="capitalize line-clamp-2 cursor-default ">
                      {name}
                    </h3>
                ...
                >
                  ...
                  <span
                    className={cn(
                      "absolute bottom-0 w-2 text-center  leading-[1.5] right-[0.15rem] whitespace-nowrap cursor-pointer z-50",
