...
import { bubble, bubbles, hero, HeroBubble, herotextBubble } from "@/constants/icons2";
      ...
      <div className="size-full flex-column gap-8 sm:row-flex !items-start">
        <div className="flex-1 px-[max(1.2em,_5%)]">
          <h1 className="relative max-sm:text-center">
            ...
            ping the <span className="text-secondary">leaders of tomorrow </span> is our top{" "}
            <br className="hidden xl:block" /> priority at {""}
          ...
          <Link to="/admission" className="mt-10 row-flex w-max max-sm:mx-auto">
